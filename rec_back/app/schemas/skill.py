...
class SkillBase(BaseModel):
    ...
    skill_type: Optional[str] = Field("technical", regex="^(technical|soft|language|certification)$")
...
class SkillSearchFilters(BaseModel):
    ...
    # Sorting
    sort_by: Optional[str] = Field("name", regex="^(name|usage_count|created_at|updated_at)$")
